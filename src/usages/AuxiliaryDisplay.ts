export namespace AuxiliaryDisplay {
  export const UsagePage = () => 0x14;
}

export enum AuxiliaryDisplay {
  ...
  AttributeData = 0x4A,
  CharAttributeEnhance = 0x4B,
  CharAttributeUnderline = 0x4C,
  CharAttributeBlink = 0x4D,
  BitmapSizeX = 0x80,
  BitmapSizeY = 0x81,
  MaxBlitSize = 0x82,
  BitDepthFormat = 0x83,
